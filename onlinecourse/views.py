...
from .models import Course, Enrollment, Submission, Question, Choice, Learner
...
def submit(request, course_id):
    ...
    submission.answers = extract_answers(request)
    submission.save()
...
def show_exam_result(request, course_id, submission_id):
    ...
    questions = Question.objects.get(course_id=course_id)
    submission = Submission.objects.get(id=submission_id)
    choices = submission.answers
    grade_score = {}
